...
public final class Constants {
    ...
    public static class Preferences {
        ...
        public static class QsTilesCustomization {
            ...
            public static final String QS_SLIDERS_RADIUS_SWITCH = "qs_sliders_radius_switch";
            public static final String QS_SLIDERS_RADIUS = "qs_sliders_radius";
        ...
        public static class LockscreenWidgets {
            ...
            public static final String LOCKSCREEN_WIDGETS_TOP_MARGIN = "lockscreen_widgets_top_margin";
        ...
        public static class LockscreenNowBar {
            ...
            public static final String[] NOW_BAR_MUSIC_PREFS = {
                    NOW_BAR_MUSIC_EXTENDED_PLAYER,
    ...
    public static final String ACTIONS_USER_UNLOCKED = BuildConfig.APPLICATION_ID + ".ACTIONS_USER_UNLOCKED";

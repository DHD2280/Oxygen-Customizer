...
public class UsbAdapter extends RecyclerView.Adapter<UsbAdapter.ViewHolder> {
    ...
    public UsbAdapter(Context context, ArrayList<NotificationModel> itemList, LoadingDialog loadingDialog) {
    ...
    @SuppressLint("SetTextI18n")
    @Override
    public void onViewAttachedToWindow(@NonNull UsbAdapter.ViewHolder holder) {

    ...
    public void show(String title, String desc) {
        ...
        arrow.setOnClickListener(v -> {
            if (dialog.findViewById(R.id.logs_layout).getVisibility() == View.GONE) {
                ...
                arrow.setIcon(ResourcesCompat.getDrawable(OxygenCustomizer.getAppContext().getResources(), R.drawable.ic_collapse_arrow, null));
            } else {
                dialog.findViewById(R.id.logs_layout).setVisibility(View.GONE);
                arrow.setIcon(ResourcesCompat.getDrawable(OxygenCustomizer.getAppContext().getResources(), R.drawable.ic_expand_arrow, null));
            }
        });
